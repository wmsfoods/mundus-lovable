...
export type SupplierOfferStatus = "active" | "new" | "negotiating" | "closed" | "inactive" | "sold_out" | "draft";
...
export const MOCK_SUPPLIER_OFFERS: SupplierOffer[] = [
  ...
  { id:"so-0010", status:"closed", category:"Pork", condition:"Frozen", title:"Pork Loin", mixed:false, cutsLabel:"Pork Loin", originCountry:"Brazil", originCountryCode:"BR", originPort:"Itajai", destinations:[{name:"China", code:"CN"}], incoterms:["CIF"], shipmentLabel:"March 2026", totalKg:27000, containerSize:"40ft", fclCount:1, pricePerFclUsd:102600, askingPrice:107730, floorPrice:92340, paymentTerms:"30% Advance, Balance TT - Against finalized doc copies", observation:null, items:[{name:"Pork Loin", marbling:"\n", qtyKg:27000, pricePerKgUsd:3.80}], active:false },
  { id:"so-0011", status:"negotiating", category:"Poultry", condition:"Frozen", title:"Chicken Breast Skinless", mixed:false, cutsLabel:"Chicken Breast Skinless", originCountry:"Brazil", originCountryCode:"BR", originPort:"Itajai", destinations:[{name:"Ghana", code:"GH"}], incoterms:["CFR"], shipmentLabel:"May 2026", totalKg:27000, containerSize:"40ft", fclCount:1, pricePerFclUsd:62100, askingPrice:65205, floorPrice:55890, paymentTerms:"30% Advance, Balance TT - Against finalized doc copies", observation:null, items:[{name:"Chicken Breast Skinless", marbling:"\n", qtyKg:27000, pricePerKgUsd:2.30}], active:true },
  { id:"so-0012", status:"active", category:"Lamb", condition:"Chilled", title:"Lamb Carcass", mixed:false, cutsLabel:"Lamb Carcass", originCountry:"Brazil", originCountryCode:"BR", originPort:"Santos", destinations:[{name:"Saudi Arabia", code:"SA"}], incoterms:["CIF"], shipmentLabel:"April 2026", totalKg:13000, containerSize:"20ft", fclCount:1, pricePerFclUsd:109200, askingPrice:114660, floorPrice:98280, paymentTerms:"30% Advance, Balance TT - Against finalized doc copies", observation:null, items:[{name:"Lamb Carcass", marbling:"\n", qtyKg:13000, pricePerKgUsd:8.40}], active:true },
];
