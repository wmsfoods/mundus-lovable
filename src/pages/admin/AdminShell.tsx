...
import {
  ...
  Search as SearchIcon, UserSearch, ClipboardList, UserCheck, Inbox, BookOpen, Database, Server,
} from "lucide-react";
...
export default function AdminShell() {
  ...
  const ADMIN_NAV: SidebarItem[] = [
    ...
    { to: "/admin/docs", label: t("admin.shell.nav.documents", "Documents"), icon: BookOpen as unknown as IconCmp, groupLabel: t("admin.shell.nav.documents_group", "DOCUMENTS") },
    { to: "/admin/docs/platform", label: t("admin.shell.nav.documents_platform", "Platform"), icon: Server as unknown as IconCmp },
  ];
